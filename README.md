...
Application which retrieves and sends data to Bridge International test Api (https://androidtechnicaltestapi-test.bridgeinternationalacademies.com/swagger/index.html). I used MVVM architecture with repository pattern and RxJava for asynchronous operations. Utilized Room database for local persistence and Koin for dependency inject. For unit tests I used Mockito. 
